...
import { Tag } from "../renderer/components/TagFilter/useTags";
...
export const TagFilterProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <TagFilterContext.Provider value={{ selectedTags, setSelectedTags, addTag, removeTag, clearTags }}>
      {children}
